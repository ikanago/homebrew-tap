class Omekasy < Formula
  ...
  if OS.mac?
    url "#{homepage}/releases/download/v#{version}/gobang-#{version}-x86_64-apple-darwin.tar.gz"
    sha256 "c516bb17ca32f4ff97d5ab233d21bcfcf8a19d5b88d9667d1c09c5dcfaad1431"
  elsif OS.linux?
    url "#{homepage}/releases/download/v#{version}/gobang-#{version}-x86_64-unknown-linux-gnu.tar.gz"
